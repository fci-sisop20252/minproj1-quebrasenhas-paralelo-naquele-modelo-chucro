...
int main(int argc, char *argv[]) {
    ...
    // IMPLEMENTE AQUI: Loop para criar workers
      for (int i = 0; i < num_workers; i++) {
        // TODO: feito Calcular intervalo de senhas para este worker
        ...
        // TODO: feito Converter indices para senhas de inicio e fim
        ...
        pid_t pid = fork(); // é tipo um ID (ent cada criação um fork é gerado um ID) TODO 4
        
        if (pid < 0){ 
          printf("Error"); // TODO 7
          exit(1);
        }
        if(pid == 0){ // ID foi criado ent começou o processo de virar work  TODO 5
